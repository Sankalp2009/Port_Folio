...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Analytics platform for social media management with data visualization, scheduling, and engagement metrics.',
    ...
    },
    {
      ...
      description: 'AI-powered tool for generating marketing content, blog posts, and social media captions using advanced language models.',
